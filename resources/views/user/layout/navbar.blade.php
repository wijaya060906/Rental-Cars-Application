    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="{{ route('daftar.mobil') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Daftar Mobil</a>
                <a href="{{ route('transaksi.user')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Mobil Sewa</a>
