          ...
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-section">
                ...
                <li class="nav-item">
                <a href="{{route('petugas.mobil')}}">
                  <i class="fas fa-layer-group"></i>
                  <p>Data Mobil</p>
                </a>
                </li>
                <li class="nav-item">
                <a href="{{route('petugas.kembali.kembali')}}">
                ...
                <li class="nav-item">
                <a href="{{ route('logout.pengelola') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                  <i class="fas fa-sign-out-alt"></i>
                  <p>Logout</p>
                </a>
                <form id="logout-form" action="{{ route('logout.pengelola') }}" method="POST" style="display: none;">
                  @csrf
                </form>
                </li>
            </ul>
